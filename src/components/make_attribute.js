...
var comida = ["Dorayaki", "Sushi", "Curry", "Yakisoba", "Cerdo dulce", "Ramen", "Soba fideos", "Satay", "Nieve mango",
...
*/
var precio = [46600,39600,42500,48900,41000,40000,51600,38600,43800,51300,46700,47000,46500,45600,46000,43600,46100,39600,46500,40600,36700];

var imagen = ["img/1.jpg","img/2.jpg","img/3.jpg","img/4.jpg","img/5.jpg","img/7.jpg","img/8.jpg","img/9.jpg","img/10.jpg","img/11.jpg","img/12.jpg","img/13.jpg","img/14.jpg","img/15.jpg","img/16.jpg","img/17.jpg","img/18.jpg","img/19.jpg","img/20.jpg","img/21.jpg"]
...
function make_attribute() {
    ...
    let B = (b0 % 20);
    let A = ((b0 + (20 - B)) / 20) % 21;
    let product = new Product(comida[A], N,precio[A], imagen[A]);
    return product;
}
